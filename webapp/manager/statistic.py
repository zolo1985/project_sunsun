...
manager_statistic_blueprint = Blueprint('manager_statistic', __name__)


@manager_statistic_blueprint.route('/manager/orders-stats', methods=['GET','POST'])
@login_required
@has_role('manager')
def manager_orders_stats():
    ...
    if form.validate_on_submit():
        ...
        if form.select_option.data == "Өдөр":
            ...
            return render_template('/manager/stats/yearly_stats.html', data1=completed, data2=cancelled, data3=postphoned, data4=months, form=form, selected_date=form.date.data.month, completed_rate=completed_rate, cancelled_rate=cancelled_rate, postphoned_rate=postphoned_rate)
        else:
            return redirect(url_for('manager_analytics.manager_orders_stats'))

    return render_template('/manager/stats/stats.html', form=form)




@manager_statistic_blueprint.route('/manager/drivers-stats', methods=['GET','POST'])
@login_required
@has_role('manager')
def manager_drivers_stats():
    ...
    if form.validate_on_submit():
        ...
        if form.select_option.data=="Өдөр":
            ...
            return render_template('/manager/stats/daily_stats.html', data1=completed, data2=cancelled, data3=postphoned, data4=form.date.data.strftime('%Y-%m-%d'), form=form, selected_date=form.date.data.strftime('%Y-%m-%d'), completed_rate=completed_rate, cancelled_rate=cancelled_rate, postphoned_rate=postphoned_rate)
    ...
    return render_template('/manager/stats/drivers_stats.html', form=form)



@manager_statistic_blueprint.route('/manager/suppliers-stats', methods=['GET','POST'])
@login_required
@has_role('manager')
def manager_suppliers_stats():
    ...
    if form.validate_on_submit():
        ...
        if form.select_option.data=="Өдөр":
            ...
            return render_template('/manager/stats/yearly_stats.html', data1=completed, data2=cancelled, data3=postphoned, data4=months, form=form, selected_date=form.date.data.month, selected_year=form.date.data.year, completed_rate=completed_rate, cancelled_rate=cancelled_rate, postphoned_rate=postphoned_rate)
        
    return render_template('/manager/stats/supplier_stats.html', form=form)